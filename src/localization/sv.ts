...
export const sv: Record<TranslationKeys, string> = {
  ...
  // Attribute names
  ASIO: "ASIO",
  BearingCapacity: "Bärighet",
  Climate: "Klimat",
  DegeneratedLand: "Impediment",
  Ditching: "Dikning",
  EarlierLandUse: "Tidigare markanvändning",
  FrostExposure: "Frostexponering",
  GroundLayer: "Bottenskikt",
  LandUseSVL: "Markanvändning (SVL)",
  LandUseTrad: "Markanvändning (Traditionell)",
  LateralSoilWater: "Sidovatten",
  ManagementClass: "Målklass",
  MaturityClass: "Huggningsklass",
  ParticleFraction: "Kornfraktion",
  Slope: "Lutning",
  SlopeDirection: "Lutninsriktning",
  Soil: "Jordart",
  SoilDepth: "Jorddjup",
  SoilMoisture: "Markfuktighet",
  SoilTexture: "Jordmån",
  species: "Ståndortsindex",
  SiteIndexSpec: "Ståndortsindex",
  speciesHeight: "höjd",
  population: "Population",
  treeLayer: "Trädskikt",
  treeSpecies: "Trädslag",
  treeSpecies_ref: "Trädslag (ref)",
  objectPopulationId: "Population ID",
  areaWeightedAge: "Ytvägd ålder",
  weightedDiameter: "Viktad diameter",
  meanHeight: "Medelhöjd",
  standBasalArea: "Grundyta",
  areaStandVolume: "Volym per ha",
  areaStemNumber: "Stamantal per ha",
  speciesDistributionVolume: "Trädslagsfördelning (volym)",
